...
static int ax88179_bind(struct usbnet *dev, struct usb_interface *intf)
{
	...
	printk("KALLE CRLKSRC_FSYS: %x TOP2: %x CORE1 %x DIV2_CESL %x\n", 
	       readl(EXYNOS5_CLKSRC_FSYS), readl(EXYNOS5_CLKSRC_TOP2), readl(EXYNOS5_CLKSRC_CORE1),
	       readl(EXYNOS5_PLL_DIV2_SEL));
	printk("KALLE DIV_FSYS0 %x\n", readl(EXYNOS5_CLKDIV_FSYS0));
